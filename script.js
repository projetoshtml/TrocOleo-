...
// =============================================
//  TOAST — notificação flutuante personalizada
// =============================================
function showToast(type) {
  // Remove toast anterior se existir
  const existing = document.getElementById('trocóleo-toast');
  if (existing) existing.remove();

  const isSuccess = type === 'success';

  const toast = document.createElement('div');
  toast.id = 'trocóleo-toast';
  ...
  toast.innerHTML = isSuccess ? `
    ...
    <div class="toast-body">
      ...
      <span class="toast-sub">
        <i class="fab fa-whatsapp"></i> (11) 9 1733 4614
      </span>
    </div>
  ...
  // Estilos inline do toast (autossuficiente, sem precisar tocar no CSS)
  ...
  if (!document.getElementById('toast-keyframes')) {
    ...
    style.textContent = `
      ...
      #trocóleo-toast .toast-icon { font-size: 2rem; flex-shrink: 0; margin-top: 2px; }
      #trocóleo-toast .toast-icon-success { color: #2ecc71; }
      #trocóleo-toast .toast-icon-error   { color: #e74c3c; }
      #trocóleo-toast .toast-body { flex: 1; }
      #trocóleo-toast .toast-body strong {
        display: block; font-size: 1rem; margin-bottom: 6px; color: #fff;
      }
      #trocóleo-toast .toast-body p {
        font-size: 0.88rem; color: #bbb; line-height: 1.5; margin: 0 0 8px;
      }
      #trocóleo-toast .toast-sub {
        font-size: 0.88rem; color: #2ecc71; font-weight: 700;
      }
      #trocóleo-toast .toast-sub i { margin-right: 4px; }
      #trocóleo-toast .toast-whatsapp-btn {
      ...
      #trocóleo-toast .toast-whatsapp-btn:hover { background: #20b858; }
      #trocóleo-toast .toast-close {
        background: none; border: none; color: #666; cursor: pointer;
        font-size: 1rem; padding: 0 0 0 4px; flex-shrink: 0; margin-top: 2px;
        transition: color 0.2s;
      }
      #trocóleo-toast .toast-close:hover { color: #fff; }
    `;
  ...
  // Auto-remove após 7s com animação de saída
  setTimeout(() => {
...
// =============================================
//  FORMULÁRIO — envio AJAX com toast
// =============================================
